...
export default function WhatsAppFloating() {
  ...
  return (
    <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-40 flex flex-col items-end print:hidden no-print">
      {/* Floating Action Button (FAB) with Blinking Pulse */}
      <a
        href={whatsappUrl}
        target="_blank"
      ...
      >
        {/* Blinking Pulse Radar Rings */}
        <span className="absolute -inset-1.5 rounded-full bg-[#25D366] opacity-40 animate-ping -z-10 pointer-events-none" />
