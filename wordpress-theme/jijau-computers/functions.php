...
function jijau_computers_customizer($wp_customize) {
    ...
    $wp_customize->add_control('jijau_whatsapp', array('label' => __('WhatsApp Number (e.g. 918805607908)', 'jijau-computers'), 'section' => 'jijau_store_settings', 'type' => 'text'));

    // UPI ID
    $wp_customize->add_setting('jijau_upi_id', array('default' => '8805607908@ybl', 'sanitize_callback' => 'sanitize_text_field'));
    $wp_customize->add_control('jijau_upi_id', array('label' => __('Store UPI VPA ID (For Instant GPay/PhonePe/Paytm)', 'jijau-computers'), 'section' => 'jijau_store_settings', 'type' => 'text'));
    ...
    // Store Address
    $wp_customize->add_setting('jijau_address', array('default' => 'Shop No. 12 & 13, Jijau Plaza, Near Railway Station, Shivajinagar, Pune, Maharashtra 411005', 'sanitize_callback' => 'sanitize_textarea_field'));
    $wp_customize->add_control('jijau_address', array('label' => __('Store Physical Address', 'jijau-computers'), 'section' => 'jijau_store_settings', 'type' => 'textarea'));
    ...
    $wp_customize->add_control('jijau_hours', array('label' => __('Opening Hours', 'jijau-computers'), 'section' => 'jijau_store_settings', 'type' => 'text'));
