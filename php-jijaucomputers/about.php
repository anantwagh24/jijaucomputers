...
$pageTitle = 'About Us - ' . ($storeSettings['storeName'] ?? 'Jijau Computers') . ' | Tech Hardware Experts';
require_once __DIR__ . '/includes/header.php';
?>

<div style="background: #020617; color: white; min-height: 80vh; padding: 40px 16px;">
  <div style="max-width: 1000px; margin: 0 auto;">
    <!-- Hero Header -->
    <div style="text-align: center; margin-bottom: 48px;">
      <span style="display: inline-block; padding: 4px 12px; background: rgba(59,130,246,0.2); border-radius: 20px; font-size: 12px; font-weight: 700; color: #60a5fa; margin-bottom: 12px;">YOUR TRUSTED TECH DESTINATION</span>
      <h1 style="font-size: 36px; font-weight: 900; margin: 0 0 16px;">Empowering Maharashtra with Cutting-Edge Computing</h1>
      <p style="color: #94a3b8; font-size: 16px; max-width: 700px; margin: 0 auto; line-height: 1.6;">
        Providing high-performance gaming rigs, enterprise workstations, Apple MacBooks, OEM computer accessories, and certified repair services across Maharashtra.
      </p>
    </div>

    <!-- Core Pillars Grid -->
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 24px; margin-bottom: 48px;">
      <div style="background: #1e293b; border-radius: 12px; border: 1px solid #334155; padding: 24px; text-align: center;">
