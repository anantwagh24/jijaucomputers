...
const sampleHappyCustomers = [
  ...
  },
  {
    ...
    review: "Purchased Apple MacBook Air M3 for my architecture studio. Got official authorized dealer discount and full manufacturer brand warranty.",
    rating: 5,
    purchaseDate: "Aug 2026",
    isFeatured: true,
    isActive: true,
  ...
  },
  {
    ...
    review: "Purchased from Jijau Computers. Unbeatable price on HP OMEN and free gaming backpack + mouse combo. Highly recommend!",
    rating: 5,
  ...
  },
  {
    ...
    review: "Best tech buying experience. Team assisted with data migration from my old laptop in under 30 minutes free of charge.",
    rating: 5,
    purchaseDate: "Jul 2026",
    isFeatured: true,
    isActive: true,
